...
# El 'continue' bloquea mientras corre el programa. Con ventanas de ~5 min hay
# que dar margen (load + 300s + overhead). Configurable por env GDB_TIMEOUT.
GDB_TIMEOUT = int(os.environ.get("GDB_TIMEOUT", "480"))
GDB_SCRIPT = """\
set pagination off
set confirm off
target remote :3333
