...
% TODO (tesis): convertir "Este trabajo propone..." a voz ejecutada
% ("En este trabajo se integró..."); actualizar la sección de estructura
% del documento a los capítulos nuevos (implementación, resultados,
% conclusiones); opcional: cerrar la intro con una síntesis de resultados.
